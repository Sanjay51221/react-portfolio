    ...
    <GlassSection id="skills" title="Skills">
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
        {skills.map((s, i) => (
          <div
            key={i}
            className="h-36 sm:h-40 md:h-48 rounded-3xl flex flex-col items-center justify-center bg-white/50 backdrop-blur border shadow"
          >
            <div className="text-4xl text-emerald-500">{s.icon}</div>
