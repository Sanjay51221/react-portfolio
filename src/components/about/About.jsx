...
const images = ["/photo1.jpeg", "/photo3.jpeg"]
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        <div className="flex justify-center">
          <img
            src={images[imageIndex]}
            alt="Sanjay"
            className="w-64 h-[360px] sm:w-72 sm:h-[400px] md:w-80 md:h-[460px] object-cover rounded-3xl shadow-2xl"
          />
        </div>

        <div className="space-y-5 text-sm sm:text-base md:text-lg">
          <p className="uppercase tracking-widest text-emerald-500 text-xs">
            Who I am
          </p>

          <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold">
            Building fast, clean & human interfaces
          </h3>

          <p className="text-gray-600 dark:text-gray-400">
            I focus on performance, usability, and clarity.
          </p>
        </div>
