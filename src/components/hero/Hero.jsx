...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
        {/* LEFT */}
        <div
          className=" space-y-6 order-2 lg:order-1 space-x-6 p-5 md:p-10bg-white/40 dark:bg-gray-900/40 backdrop-blur-xl
        ...
        {/* RIGHT (IMAGE) */}
        <div className="flex justify-center lg:justify-end order-1 lg:order-2 mt-12 sm:mt-16 lg:mt-0">
